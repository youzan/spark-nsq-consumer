...
object NSQExample {
  def main(args: Array[String]): Unit = {
    def createContext(checkpointDirectory: String, parallism: Int, nsqConfig: String)
    : StreamingContext = {
      ...
      val config = Source.fromFile(nsqConfig)
    ...
    val Array(checkpointDirectory, parallism, nsqConfig) = args
    val ssc = StreamingContext.getOrCreate(checkpointDirectory,
      () => createContext(checkpointDirectory, parallism.toInt, nsqConfig))
